      ...
      <DialogOverlay>
        ...
        >
          ...
          <DialogPrimitive.Close
            className={`web:group absolute right-4 top-4 rounded-sm p-0.5 opacity-70 web:ring-offset-background
              web:transition-opacity web:hover:opacity-100 web:focus:outline-none web:focus:ring-2
              web:focus:ring-ring web:focus:ring-offset-2 web:disabled:pointer-events-none`}
          >
            <X
