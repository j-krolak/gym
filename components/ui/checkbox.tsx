...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      className={cn(
        `web:peer native:h-[20] native:w-[20] native:rounded h-4 w-4 shrink-0 rounded-sm border-2
        border-gray-600 disabled:cursor-not-allowed disabled:opacity-50
        ...
        props.checked && "border-green-600 bg-green-600",
        className,
      )}
      {...props}
    >
